...
% === 字體與語言設定 (整合與修正) ===
\usepackage[no-math]{fontspec}   % 讓 XeLaTeX 支援系統字體
\setmainfont{Times New Roman}    % 設定預設英文字體為 Times New Roman

\usepackage{xeCJK}               % 讓中英文字體分開設置 
\usepackage[UTF8,fontset=none,scheme=plain]{ctex}
\setCJKmainfont[Path = ./fonts/, AutoFakeBold={4}, AutoFakeSlant=0.2]{TW-Kai.ttf} % 設定預設中文字體

\usepackage{CJKnumb}             % 中文數字支援
